...
(D) Procedure for Transfer Learning using UEA multivariate Time Series Classification datasets 
	## Pretrained DATA should be additionally downloaded and located in 'D.Multivariate-ts_transfer/Multivariate_ts' folder
		## ChracterTrajectories, InsectWingbeat, JapaneseVowels, Libras, SpokenArabicDigits data should be removed
